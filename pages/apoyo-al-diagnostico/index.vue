<template>
  ...
  >
    <div class="relative container w-full py-8 lg:py-24 text-center z-40">
      <h1 class="text-5xl mb-3 text-primary">
  ...
  <section class="relative items-center w-full py-12 lg:py-32">
    <div class="container">
      <div class="grid grid-cols-2 gap-5">
        <div v-for="item in items" class=" rounded-lg overflow-hidden shadow-lg">
          <img
            class="w-full"
            :src="item.image_url"
            :alt="item.name"
...
const init = async () => {
  ...
  let servicesRes  = await fetch('https://goyeneche.linox.net.pe/api/apoyo-al-diagnostico');
