  ...
  <section class="relative items-center w-full py-12 lg:py-32">
    <div class="container">
      <div class="grid grid-cols-1 gap-5">
        <div
          v-for="item in items"
          class="rounded-lg overflow-hidden shadow-lg col-span-2 md:col-span-1"
        >
...
const url = "https://goyeneche.linox.net.pe/api/circuitos-de-atencion";
