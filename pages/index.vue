<template>
  ...
  >
    <div class="relative items-center w-full py-12 lg:py-32">
      <div class="container mb-6 items-center flex justify-between">
        <div>
        ...
        <div class="flex justify-end ">
          <NuxtLink
            class="group text-lg font-semibold text-gray-700 hover:text-primary transition ease-in-out duration-200"
            to="/noticias"
          >
            Ver todas <i class="fas fa-arrow-right inline-block translate-x-0 group-hover:translate-x-1 transition-transform ease-in-out duration-200"></i>
          </NuxtLink>
        </div>
      </div>
  ...
  <section class="bg-gradient-to-tl from-gray-50 via-slate-100 to-slate-50">
    <div class="relative items-center w-full pt-12 lg:pt-32">
      <div class="container mb-6 flex justify-between">
      ...
      <div class="container mb-6 flex justify-between" >
        ...
        <div class="flex justify-end ">
          <NuxtLink
            ...
            to="/medicos"
          >
            Ver todo <i class="fas fa-arrow-right inline-block translate-x-0 group-hover:translate-x-1 transition-transform ease-in-out duration-200"></i>
          </NuxtLink>
        </div>
      </div>
  ...
  <div>
      ...
      <div class="relative w-auto my-6 mx-auto max-w-6xl">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          ...
          <div class="relative  flex-auto">
            ...
            <button class="m-3 absolute top-0 right-0  p-1 ml-auto bg-transparent border-0 text-black  float-right text-3xl leading-none font-semibold outline-none focus:outline-none" v-on:click="toggleModal()">
              <i class="fas fa-times"></i>
            </button>

            <img :src="imgModal[0].image_url" :alt="imgModal[0].title" class="w-full h-full object-cover rounded-lg" loading="lazy" />
          </div>
          <!--footer-->
    ...
    <div v-if="showModal" class="opacity-25 fixed inset-0 z-40 bg-black" @click="toggleModal()"></div>
  </div>
</template>
